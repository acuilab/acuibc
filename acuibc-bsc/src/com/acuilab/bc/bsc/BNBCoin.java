 ...
 * @author admin
 */
public class BNBCoin implements ICoin {

    private static final Logger LOG = Logger.getLogger(BNBCoin.class.getName());
    ...
    public Icon getIcon(int size) {
        return ImageUtilities.loadImageIcon("/resource/bnb" + size + ".png", true);
    }

    @Override
    public Image getIconImage(int size) {
        return ImageUtilities.loadImage("/resource/bnb" + size + ".png", true);
    }

    @Override
    public BigInteger balanceOf(String address) throws Exception {
        BSCBlockChain bc = Lookup.getDefault().lookup(BSCBlockChain.class);
