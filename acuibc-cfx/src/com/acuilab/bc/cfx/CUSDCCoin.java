 ...
 * @author admin
 */
public class CUSDCCoin extends ERC20Coin {
    
    private static final Logger LOG = Logger.getLogger(CUSDCCoin.class.getName());

    public static final String CONTRACT_ADDRESS = "cfx:aca13suyk7mbgxw9y3wbjn9vd136swu6s21tg67xmb";

    public static final String NAME = "conflux USDC";
    public static final String SYMBOL = "cUSDC";
    ...
    public Icon getIcon(int size) {
        return ImageUtilities.loadImageIcon("/resource/usdc" + size + ".png", true);
    }

    @Override
    public Image getIconImage(int size) {
        return ImageUtilities.loadImage("/resource/usdc" + size + ".png", true);
    }
