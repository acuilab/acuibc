 ...
 * @author admin
 */
public class CUSDTCoin extends ERC20Coin {
    
    private static final Logger LOG = Logger.getLogger(CUSDTCoin.class.getName());

    public static final String CONTRACT_ADDRESS = "cfx:acf2rcsh8payyxpg6xj7b0ztswwh81ute60tsw35j7";
    ...
    public Icon getIcon(int size) {
        return ImageUtilities.loadImageIcon("/resource/cUSDT" + size + ".png", true);
    }

    @Override
    public Image getIconImage(int size) {
        return ImageUtilities.loadImage("/resource/cUSDT" + size + ".png", true);
    }
