 ...
 * @author admin
 */
public class Dan_CFXPair extends ERC20Coin {
    
    private static final Logger LOG = Logger.getLogger(Dan_CFXPair.class.getName());

    public static final String CONTRACT_ADDRESS = "cfx:acev373xcghbefgmyn2jbdnu5nv96nac8j9ymcdky6";

    public static final String NAME = "DAN-CFX Pair";
    ...
    public String getSymbol() {
        return Constants.CFX_DAN_CFX_PAIR_SYMBOL;
    }
