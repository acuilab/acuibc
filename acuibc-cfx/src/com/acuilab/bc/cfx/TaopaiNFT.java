 ...
 * @author admin
 */
public class TaopaiNFT extends AbstractNFT {

    public static final String CONTRACT_ADDRESS = "cfx:achew68x34cwu04aezbunyaz67gppakvmyn79tau56";
    public static final String WEBSITE = "http://www.taopainft.com";
    ...
    public Icon getIcon(int size) {
        return ImageUtilities.loadImageIcon("/resource/taopainft" + size + ".png", true);
    }

    @Override
    public Image getIconImage(int size) {
        return ImageUtilities.loadImage("/resource/taopainft" + size + ".png", true);
    }
