 ...
 * @author admin
 */
public class TopOfThreeKingdomNFT extends AbstractNFT {
    
    public static final String CONTRACT_ADDRESS = "cfx:acepdehsmt07kcd2hspae9dashzgddrva240azrmm5";
