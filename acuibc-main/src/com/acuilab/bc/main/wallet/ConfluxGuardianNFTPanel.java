 ...
 * @author admin
 */
public class ConfluxGuardianNFTPanel extends JXPanel {
     ...
     */
    public ConfluxGuardianNFTPanel(Wallet wallet, INFT nft, MetaData metaData) {
	initComponents();
        this.wallet = wallet;
        this.nft = nft;
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(nameLbl, org.openide.util.NbBundle.getMessage(ConfluxGuardianNFTPanel.class, "ConfluxGuardianNFTPanel.nameLbl.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(idLbl, org.openide.util.NbBundle.getMessage(ConfluxGuardianNFTPanel.class, "ConfluxGuardianNFTPanel.idLbl.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(platformLbl, org.openide.util.NbBundle.getMessage(ConfluxGuardianNFTPanel.class, "ConfluxGuardianNFTPanel.platformLbl.text")); // NOI18N
        ...
        descTextArea.setText(org.openide.util.NbBundle.getMessage(ConfluxGuardianNFTPanel.class, "ConfluxGuardianNFTPanel.descTextArea.text")); // NOI18N
        jScrollPane1.setViewportView(descTextArea);

        org.openide.awt.Mnemonics.setLocalizedText(jXButton1, org.openide.util.NbBundle.getMessage(ConfluxGuardianNFTPanel.class, "ConfluxGuardianNFTPanel.jXButton1.text")); // NOI18N
