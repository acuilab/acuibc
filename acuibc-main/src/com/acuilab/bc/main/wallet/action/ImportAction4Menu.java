 ...
 * @author admin
 */
public class ImportAction4Menu extends AbstractAction {
    
    public ImportAction4Menu() {
        putValue(NAME, "导入钱包");
        putValue(SMALL_ICON, new javax.swing.ImageIcon(getClass().getResource("/resource/import_wallet16.png")));
    }
